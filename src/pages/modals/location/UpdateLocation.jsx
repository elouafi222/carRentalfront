...
function UpdateLocation({ token, refreshlocations, item }) {
  ...
  useEffect(() => {
    ...
    setCity({ value: item.cityId._id, label: item.cityId.name });
    setManager({
      value: item.managerId._id,
      label: `${item.managerId.firstname} ${item.managerId.lastname}`,
    });
  }, [item]);
  ...
  const addLocation = async (e) => {
    ...
    try {
      ...
      refreshlocations();
      document.getElementById("closeaddlocation").click();
      document
        ...
        <form onSubmit={addLocation} className="modal-content">
          ...
          <div className="modal-body">
            ...
            <div className="mb-3 mx-1">
              <label htmlFor="adresse">Manager</label>
              <Select
                value={manager}
            ...
            <div className="mb-3 mx-1">
              <label htmlFor="adresse">City</label>
              <Select
                value={city}
